...
import com.example.admin.foursquareapp.presenter.FilterPresenter;
import com.example.admin.foursquareapp.view.FilterView;
import com.example.admin.foursquareapp.presenter.FilterPresenterImpl;
...
public class FilterActivity extends AppCompatActivity implements View.OnClickListener, FilterView{
    ...
    @Override
    public void updateSortButton(int idChosen,int idNotChosen) {
        Button btnChosen = findViewById(idChosen);
        btnChosen.setBackgroundColor(getColor(R.color.colorAccentLight));

        Button btnNotChosen = findViewById(idNotChosen);
        btnNotChosen.setBackgroundColor(getColor(R.color.icons));
